            ...
            <div className="bar-quotes-n-activity">
              <div className="col">
                <div className="lead-msg">
                  ...
                  <h5>{$p.msgTitle}</h5>
                  <div className="desc">Share a message, photo, or memory of {$p.profileName}. You can also research historical information (if applicable) and award a badge of honor. <a>Read more</a></div>
                </div>
              </div>
